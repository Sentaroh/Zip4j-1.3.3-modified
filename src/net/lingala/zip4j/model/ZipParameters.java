...
public class ZipParameters implements Cloneable {
	...
	private String[] compressFileExtentionExcludeList=new String[]{""};
	
	public void setCompressFileExtentionExcludeList(String noCompExtList) {
		if (noCompExtList!=null && !noCompExtList.equals("")) 
			compressFileExtentionExcludeList=noCompExtList.split(";");
	}
	public String[] getCompressFileExtentionExcludeList() {return compressFileExtentionExcludeList;}
	@SuppressLint("DefaultLocale")
	public boolean isCompressFileExtention(String fileName) {
		boolean result=true;
		String[] nc_list=getCompressFileExtentionExcludeList();
		if (nc_list!=null && nc_list.length>0) {
			for(String nc_item:nc_list) {
				if (fileName.toLowerCase().endsWith("."+nc_item)) {
					result=false;
					break;
				}
			}
	...
	public ZipParameters() {
		...
		setCompressFileExtentionExcludeList(
			"aac;avi;gif;ico;gz;jpe;jpeg;jpg;m3u;m4a;m4u;mov;movie;mp2;mp3;"
			+ "mpe;mpeg;mpg;mpga;ogg;png;qt;ra;ram;svg;tgz;wmv;");
	}
